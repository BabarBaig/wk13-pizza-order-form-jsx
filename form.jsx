...
class ReactIntro extends React.Component {
  /**
   * Function to handle submission of the pizza form. It will grab values
   * from the element IDs, construct a string, and then both alert that string
   * and add it to the DOm in the most-recent-order div.
  ...
  render() {
    // TODO: Your task is to fill in the appropriate html fields within the form
    // provided below to take a pizza order.
    ...
    return (
      <div>
        <form onSubmit={this.handleSubmit.bind(this)}>
          ...
          <input id="form-submit" type="submit" value="Submit Query"/>
        </form>
      </div>
    );
  }
